...
import Diff.APIElementType;
import Diff.Add;
import Diff.AddParameter;
import Diff.AddRestriction;
import Diff.AddStatusCode;
import Diff.Change;
import Diff.ChangeFormatReturnValue;
import Diff.CombineMethods;
import Diff.Complex;
import Diff.ConsumeType;
import Diff.DefaultClause;
import Diff.DefaultValue;
import Diff.Delete;
import Diff.DeletePath;
import Diff.Diff;
import Diff.DiffFactory;
import Diff.DiffPackage;
import Diff.ElementReference;
import Diff.ElementType;
import Diff.ExposeData;
import Diff.LowerBondary;
import Diff.Modify;
import Diff.ModifyParameterSchemaType;
import Diff.MultipleParametersInOne;
import Diff.ParameterLocation;
import Diff.ParameterType;
import Diff.ProduceType;
import Diff.RefactoringType;
import Diff.RelocateParameter;
import Diff.RemoveParameter;
import Diff.RemoveRestriction;
import Diff.RemoveStatusCode;
import Diff.RenameMethod;
import Diff.RenameParameter;
import Diff.ReturnType;
import Diff.SameParameter;
import Diff.Schema;
import Diff.Simple;
import Diff.SplitMethod;
import Diff.UnsupportRequestMethod;
import Diff.UpperBondary;
